...
function CyberpunkLayout() {
  ...
  return (
    <>
      ...
      {showIntro && <BraindanceIntro onComplete={onIntroComplete} muted={muted} />}
      ...
      <button
        ...
        style={{
          position: 'fixed', bottom: '1.25rem', right: '1.5rem', zIndex: 100,
          background: 'rgba(10, 10, 15, 0.7)', border: '1px solid rgba(2, 215, 242, 0.3)',
          color: '#02D7F2', fontSize: '1rem', width: '2.25rem', height: '2.25rem',
