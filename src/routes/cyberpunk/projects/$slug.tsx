...
function ProjectPage() {
  ...
  if (notFound) {
    return (
      <div style={{ padding: '4rem', color: '#02D7F2', fontFamily: 'Share Tech Mono, monospace' }}>
  ...
  return (
    <div className="writeup-page">
      <div className="back-link-row">
        <button className="back-link-btn" onClick={() => navigate({ to: '/cyberpunk' })}>
          ← BACK TO NET
        </button>
      </div>
      <nav className="breadcrumb" aria-label="Breadcrumb">
        <a href="/cyberpunk" className="crumb">NIGHT CITY NET</a>
        <span className="crumb-sep">&gt;</span>
        <a href="/cyberpunk" className="crumb">SONGBIRD</a>
        <span className="crumb-sep">&gt;</span>
        <a href="/cyberpunk" className="crumb">PROJECTS</a>
        <span className="crumb-sep">&gt;</span>
        ...
        <div className="project-meta-row">
          ...
          <div className="meta-tags">
            {(meta.tags || []).map((tag: string) => (
              <span key={tag} className="tag-badge">[{tag.toUpperCase()}]</span>
            ))}
          </div>
        </div>
      ...
      <div className="terminal-wrapper">
        ...
        <div className="terminal-body">
          ...
          {!cursorDone && <span className="stream-cursor" aria-hidden="true">|</span>}
        </div>
      </div>
