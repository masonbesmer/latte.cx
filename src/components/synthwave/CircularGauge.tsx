...
export function CircularGauge({ value, label, sub, color, size = 100 }: CircularGaugeProps) {
  ...
  return (
    <div className="sw-gauge-panel">
      ...
      <div className="sw-gauge-label" style={{ color: strokeColor, textShadow: `0 0 6px ${strokeColor}` }}>
        {label}
      </div>
