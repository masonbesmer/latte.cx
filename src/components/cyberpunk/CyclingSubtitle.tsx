...
export function CyclingSubtitle() {
  ...
  return (
    <span className="cycling-subtitle" aria-live="polite" aria-atomic="true" aria-label={displayed || 'loading role'}>
      {displayed}
      <span style={{ display: 'inline-block', color: '#25E1ED', opacity: cursorVisible ? 1 : 0, transition: 'opacity 0.05s' }}>█</span>
      <style>{`
