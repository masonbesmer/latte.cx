      ...
      >
        <p
          style={{
            ...
            textShadow: "0 0 10px rgba(37,225,237,0.6)",
        ...
        <p
          style={{
            ...
            color: "#25E1ED",
            margin: 0,
            animation: "ct-success-in 400ms ease 300ms forwards",
            opacity: 0,
          }}
        >
        ...
        <p
          style={{
            ...
            color: "#25E1ED",
            margin: 0,
            animation: "ct-success-in 400ms ease 600ms forwards",
            opacity: 0,
          }}
        >
      ...
      >
        ...
        >
          <label style={labelStyle} htmlFor="ct-name">
            <span style={{ color: "#25E1ED", marginRight: "0.25rem" }}>
              &gt;
            </span>{" "}
            IDENTIFY:
          </label>
          <input
            ...
            style={{
              ...inputStyle,
              borderColor: errors.name ? "#FF1111" : "#02D7F2",
            }}
            type="text"
            autoComplete="name"
        ...
        {visibleFields >= 2 && (
          ...
          >
            ...
            <input
              ...
              style={{
                ...inputStyle,
                borderColor: errors.email ? "#FF1111" : "#02D7F2",
              }}
              type="email"
              autoComplete="email"
        ...
        {visibleFields >= 3 && (
          ...
          >
            ...
            <input
              ...
              style={{
                ...inputStyle,
                borderColor: errors.subject ? "#FF1111" : "#02D7F2",
              }}
              type="text"
        ...
        {visibleFields >= 4 && (
          ...
          >
            ...
            <textarea
              ...
              style={{
                ...inputStyle,
                border: `1px solid ${errors.message ? "#FF1111" : "rgba(2,215,242,0.4)"}`,
