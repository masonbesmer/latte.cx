import { services } from "../../lib/vinyl-data";
...
export function ShelfHeader() {
  ...
  return (
    <header
      ...
      style={{
        background:
          "linear-gradient(135deg, #2a1a10 0%, #3d2b1f 50%, #2a1a10 100%)",
    ...
    >
      ...
      >
        <div className="flex flex-col items-center">
          <span
            ...
            style={{ color: "var(--status-green)", fontSize: 18 }}
          >
            {healthyCount}
          </span>
          <span
        ...
        <div className="flex flex-col items-center">
          <span
            className="font-mono font-bold"
            style={{ color: "var(--status-amber)", fontSize: 18 }}
          >
            {warningCount}
          </span>
          <span
        ...
        <div className="flex flex-col items-center">
          <span
            className="font-mono font-bold"
            style={{ color: "var(--status-red)", fontSize: 18 }}
          >
            {downCount}
          </span>
          <span
      ...
      <div className="flex-1 min-w-0" aria-label="Service shelf">
        <p
          style={{
