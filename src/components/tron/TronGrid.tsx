...
function SceneInner() {
  ...
  useEffect(() => {
    ...
    const cam = new THREE.PerspectiveCamera(55, size.width / size.height, 0.1, 500)
    ...
    const mat = new THREE.LineBasicMaterial({ color: GRID_COLOR, transparent: true, opacity: 0.65 })
    ...
    composer.addPass(new UnrealBloomPass(new THREE.Vector2(size.width, size.height), 0.8, 0.4, 0.2))
