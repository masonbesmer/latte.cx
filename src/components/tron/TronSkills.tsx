...
const NODES: SkillNode[] = [
  // Core — center cluster
  { id: 'linux',   label: 'LINUX',   x: 400, y: 120, proficiency: 1.0, category: 'systems' },
  { id: 'docker',  label: 'DOCKER',  x: 250, y: 220, proficiency: 0.95, category: 'infra' },
  { id: 'python',  label: 'PYTHON',  x: 550, y: 220, proficiency: 0.9, category: 'lang' },

  // Left cluster — infra
  { id: 'proxmox', label: 'PROXMOX', x: 120, y: 320, proficiency: 0.9, category: 'infra' },
  { id: 'pfsense', label: 'PFSENSE', x: 120, y: 440, proficiency: 0.85, category: 'net' },
  { id: 'wireguard',label:'WIREGUARD',x: 250, y: 520, proficiency: 0.8, category: 'net' },

  // Right cluster — dev
  { id: 'js',      label: 'JAVASCRIPT',x:680, y: 320, proficiency: 0.85, category: 'lang' },
  { id: 'react',   label: 'REACT',   x: 680, y: 440, proficiency: 0.8, category: 'lang' },
  { id: 'threejs', label: 'THREE.JS', x: 560, y: 520, proficiency: 0.75, category: 'lang' },

  // Bottom cluster — hardware
  { id: 'esp32',   label: 'ESP32',   x: 250, y: 640, proficiency: 0.8, category: 'hw' },
  { id: 'ha',      label: 'HOME ASSISTANT', x: 400, y: 620, proficiency: 0.95, category: 'infra' },
  { id: 'mqtt',    label: 'MQTT',    x: 560, y: 640, proficiency: 0.85, category: 'infra' },
]
    ...
    <section id="skills" className="tron-skills" aria-label="Skills section">
      <div className="tron-skills-inner">
              ...
              return (
                ...
                >
                  ...
                  <text
                    ...
                    style={{ transition: 'all 0.3s', filter: active ? nodeGlow(node, 1.5) : undefined }}
                  >
                    {node.label}
                  </text>
                </g>
        ...
        <div className="tron-skills-legend">
          <div className="tron-legend-item"><span className="tron-legend-dot" style={{ background: '#FFFFFF' }} />SYSTEMS</div>
          <div className="tron-legend-item"><span className="tron-legend-dot" style={{ background: '#00AAFF' }} />INFRA / DEV</div>
          <div className="tron-legend-item"><span className="tron-legend-dot" style={{ background: '#FFCC00' }} />NETWORKING</div>
          <div className="tron-legend-item"><span className="tron-legend-dot" style={{ background: '#FF2200' }} />HARDWARE</div>
        </div>
      </div>
