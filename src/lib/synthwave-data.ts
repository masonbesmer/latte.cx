...
export const initialLogs: LogEntry[] = [
  {
    ...
    level: "ok",
    service: "PROXMOX",
    message: "VM 104 (plex) started successfully",
  },
  {
    id: 2,
    timestamp: "04:11:44",
    level: "info",
    service: "UNIFI",
    message: "Client 192.168.1.42 connected to AP-Living",
  },
  {
    id: 3,
    timestamp: "04:10:58",
    level: "warn",
    service: "PIHOLE",
    message: "DNS query rate spike detected: 2400 q/min",
  },
  {
    id: 4,
    timestamp: "04:09:33",
    level: "info",
    service: "HA",
    message: 'Automation "Evening Scene" triggered',
  },
  {
    id: 5,
    timestamp: "04:08:17",
    level: "ok",
    service: "GITEA",
    message: "Push received: main@latte.cx (3 commits)",
  },
  {
    id: 6,
    timestamp: "04:07:52",
    level: "info",
    service: "PLEX",
    message: "Transcode started: The Shining (1080p → 720p)",
  },
  {
    id: 7,
    timestamp: "04:07:01",
    level: "info",
    service: "MINECRAFT",
    message: "4 players online: MasonB, Alex, Steve, Creeper",
  },
  {
    id: 8,
    timestamp: "04:06:44",
    level: "ok",
    service: "GRAFANA",
    message: "Alert resolved: CPU_high on proxmox-node-1",
  },
  {
    id: 9,
    timestamp: "04:05:30",
    level: "warn",
    service: "PROXMOX",
    message: "VM 107 memory usage at 92%",
  },
  {
    id: 10,
    timestamp: "04:04:18",
    level: "info",
    service: "UNIFI",
    message: "WAN failover check passed: primary link healthy",
  },
];
...
export const newLogTemplates = [
  {
    level: "info" as const,
    service: "PROXMOX",
    message: "Backup completed: VM 105 snapshot created",
  },
  {
    level: "ok" as const,
    service: "HA",
    message: "Sensor update: thermostat set to 72°F",
  },
  {
    level: "info" as const,
    service: "UNIFI",
    message: "Client roamed: 192.168.1.88 → AP-Office",
  },
  {
    level: "warn" as const,
    service: "PROXMOX",
    message: "Storage pool usage above 70%",
  },
  {
    level: "ok" as const,
    service: "PLEX",
    message: "Library scan complete: 2 new items added",
  },
  {
    level: "info" as const,
    service: "GRAFANA",
    message: 'Dashboard "Homelab Overview" viewed',
  },
  {
    level: "info" as const,
    service: "MINECRAFT",
    message: "Player joined: ZenithCraft",
  },
  {
    level: "error" as const,
    service: "PIHOLE",
    message: "Upstream DNS timeout — falling back to secondary",
  },
  {
    level: "ok" as const,
    service: "GITEA",
    message: "CI pipeline passed: latte.cx main branch",
  },
  {
    level: "info" as const,
    service: "HA",
    message: "Motion detected: Front door camera",
  },
];
