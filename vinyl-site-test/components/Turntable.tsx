...
import { Service, getStatusColor } from '@/lib/data';
...
function Tonearm({ activity }: { activity: number }) {
  // activity 0-100 → arm angle -20° to 5°
    ...
    >
      ...
      {service && (
        <div className="text-center">
          <p
            style={{ color: 'rgba(255,255,255,0.5)', fontSize: 10, letterSpacing: '0.15em', textTransform: 'uppercase' }}
          >
            {service.artist}
          </p>
          <p
            className="font-bold"
            style={{ color: 'var(--cream)', fontSize: 15, marginTop: 2 }}
          >
            {service.albumTitle}
          </p>
