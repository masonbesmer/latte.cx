...
## Current Version: v0.5.0 — Particle System
...
- activeSection store connects +page.svelte IntersectionObserver → ParticleField color lerp and (future) ProjectCard section highlight
